#!/usr/bin/env python3
"""
Test script for method comparison with selective round attack data.
This tests the compatibility of the method comparison function with selective rounds.
...
def main():
    ...
    if not results_data:
        print("No selective round results data found")
        return
    ...
    for dataset in df['dataset'].unique():
        ...
        # Generate method comparison plots with selective round filtering and get data for CSV export
        output_path = dataset_plots_dir / "method_comparison_selective_rounds.png"
        
        plotting_data = plot_method_comparison_contribution_changes(
            dataset_df, max_clients, subtitle, output_path, 
            use_attack_round_filtering=True, use_suptitle=False, return_data=True
        )
    ...
    print("\nSelective round method comparison visualization complete!")
